...
| 2 | **Fabrication** | `fabrication-lead-magnet` | `get_brand` (CMS), skill pdf maison, `upload_file_tool` (CMS) | PDF brandé dans la bibliothèque CMS + URL publique | Gate qualité passé + PDF téléchargeable + inscrit au registre |
...
| 8 | **Nurturing** | `campagne-lead-magnet` | `rapido-marketing:email-sequence`, gate `rapido-marketing:delivrabilite-email` | Séquence J0 (livraison) / J2 (bonus) / J5 (cas + CTA RDV) | Gate délivrabilité passé + chaque lot confirmé |
