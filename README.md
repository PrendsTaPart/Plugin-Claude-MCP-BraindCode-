...
![Skills](https://img.shields.io/badge/skills-314-brightgreen)
...
| `rapido-marketing` | 0.5.0 | 9 | 0 | rapidocrm, rapidocms, rapidorh, facebook-ads, canva, lovable, n8n, gmail, google-calendar | `N8N_MCP_URL` (optionnel) |

**Total : 13 plugins, 314 skills, 25 agents.** (`rapido-startup` — finance &
