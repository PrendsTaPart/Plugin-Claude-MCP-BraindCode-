...
![Skills](https://img.shields.io/badge/skills-110-brightgreen)
...
| `rapido-startup` | 1.2.0 | 2 | 1 | stripe, rapidocrm, rapidocms, rapidorh, foodeatup | — |

**Total : 11 plugins, 110 skills, 15 agents.** (`rapido-startup` — finance &
