...
![Skills](https://img.shields.io/badge/skills-303-brightgreen)
...
| `rapidocms` | 1.5.0 | 20 | 5 | rapidocms, hyperframes | — |
...
**Total : 12 plugins, 303 skills, 24 agents.** (`rapido-startup` — finance &
...
41 des 303 skills sont importés de dépôts open source, adaptés aux
