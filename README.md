...
![Skills](https://img.shields.io/badge/skills-316-brightgreen)
...
| `rapido-marketing` | 0.7.0 | 11 | 0 | rapidocrm, rapidocms, rapidorh, facebook-ads, canva, lovable, n8n, gmail, google-calendar | `N8N_MCP_URL` (optionnel) |

**Total : 13 plugins, 316 skills, 25 agents.** (`rapido-startup` — finance &
