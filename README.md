...
| `rapidocms` | 1.11.1 | 22 | 6 | rapidocms, hyperframes | — |
...
| `rapido-meta-ads` | 1.0.3 | 13 | 1 | facebook-ads, rapidocms, rapidocrm, canva, lovable, foodeatup | — |
...
| `rapido-marketing` | 0.14.2 | 15 | 5 | rapidocrm, rapidocms, rapidorh, facebook-ads, canva, lovable, n8n, gmail, google-calendar | `N8N_MCP_URL` (optionnel) ; Fireflies = connecteur optionnel (voir README plugin) |
