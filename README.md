...
| `rapido-marketing` | 0.16.0 | 16 | 5 | rapidocrm, rapidocms, rapidorh, facebook-ads, canva, lovable, n8n, gmail, google-calendar | `N8N_MCP_URL` (optionnel) ; Fireflies = connecteur optionnel (voir README plugin) |
| `rapido-higgsfield` | 1.0.1 | 9 | 1 | huggsfield, rapidocms, rapidocrm, rapidorh, foodeatup | `HIGGSFIELD_MCP_URL` |
| `rapido-video` | 0.2.0 | 2 | 0 | rapidocms (huggsfield optionnel) | — (ffmpeg/Whisper/Remotion auto-installés) |
