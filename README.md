...
| `rapidocms` | 1.10.0 | 22 | 6 | rapidocms, hyperframes | — |
| `rapidorh` | 1.0.2 | 11 | 2 | rapidorh | — |
| `rapido-suite` | 1.4.0 | 13 | 1 | rapidocrm, rapidocms, rapidorh, foodeatup, lovable, facebook-ads, n8n | `N8N_MCP_URL` (optionnel) |
