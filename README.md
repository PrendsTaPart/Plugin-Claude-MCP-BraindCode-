...
![Skills](https://img.shields.io/badge/skills-313-brightgreen)
...
| `rapido-marketing` | 0.4.0 | 8 | 0 | rapidocrm, rapidocms, rapidorh, facebook-ads, canva, lovable, n8n, gmail, google-calendar | `N8N_MCP_URL` (optionnel) |

**Total : 13 plugins, 313 skills, 25 agents.** (`rapido-startup` — finance &
