...
Tu peux **créer des brouillons** : `create_campaign`,
`create_whatsapp_template`, `create_client` (convertir un lead) — outils
FoodEatUp uniquement : ce plugin est volontairement découplé du CRM. Tu ne peux
**JAMAIS lancer** : `launch_campaign` et `submit_whatsapp_template` sont
...
1. **Taille de segment** : `list_rfm_segments` (segments RFM FoodEatUp). Un
